...
*/ -}}
{{- define "eric-oss-2pp-egookat-poc-22.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-2pp-egookat-poc-22.mergeAnnotations" -}}
  {{- include "eric-oss-2pp-egookat-poc-22.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-2pp-egookat-poc-22.mergeLabels" -}}
  {{- include "eric-oss-2pp-egookat-poc-22.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
